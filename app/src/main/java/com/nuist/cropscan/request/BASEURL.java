...
public class BASEURL {
    ...
    public static String ip = "http://192.168.43.72";
    public static String servePort = "5000";
    public static String webPort = "9008";
    public static String entireHost = ip + ":" + servePort;
